...
XEN_OBJ=$(LWIP_OBJ) drivers/xen/xen_init.o drivers/xen/xenbus.o drivers/xen/evntchn.o drivers/xen/gntmap.o drivers/xen/gnttab.o drivers/xen/net_front.o drivers/xen/lwip-net.o drivers/xen/lwip-arch.o drivers/xen/web_server.o
